...
<%
    List<Product> list = ProductDAO.getBestsellerProducts();
...
<h2 style="text-align:center; margin-top:20px;">🔥 SẢN PHẨM BÁN CHẠY</h2>

<div class="products">
<%
    if (list.isEmpty()) {
%>
    <p style="text-align:center;">Chưa có sản phẩm bán chạy.</p>
<%
    } else {
        for (Product p : list) {
%>
